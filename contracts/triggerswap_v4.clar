...
(define-public (triggerTransferStx (preimage (buff 32)) (amount (buff 16)) (claimAddress (buff 42)) (refundAddress (buff 42)) (timelock (buff 16)) (receiver principal) (memo (string-ascii 40)))
    (begin
        (try! (contract-call? .stxswap claimStx preimage amount claimAddress refundAddress timelock))
        (try! (stx-transfer? (buff-to-uint-le amount) tx-sender receiver))
