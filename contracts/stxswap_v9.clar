...
;; @dev To query the arguments of this function, get the event logs for the SHA256 hash of the preimage
...
;; @dev To query the arguments of this function, get the event logs for your refund address and the preimage hash if you have it
