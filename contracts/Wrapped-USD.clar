...
(define-fungible-token wrapped-usd)


;; Get the token balance of the specified owner in base units
(define-read-only (get-balance (owner principal))
  (ok (ft-get-balance wrapped-usd owner)))
...
(define-public (transfer (amount uint) (sender principal) (recipient principal ) (memo (optional (buff 34) )))
  (begin
    ...
    (ft-transfer? wrapped-usd amount sender recipient) ) ) ;; Transfer
...
(define-public (mint-tokens (mint-amount uint) (mint-to principal) )
  (begin
    ...
    (ft-mint? wrapped-usd mint-amount mint-to)))
...
(define-public (burn-tokens (burn-amount uint) (burn-from principal) )
  (begin
    ...
    (ft-burn? wrapped-usd burn-amount burn-from)))
...
(define-public (revoke-tokens (revoke-amount uint) (revoke-from principal) (revoke-to principal) )
  (begin
    ...
    (ft-transfer? wrapped-usd revoke-amount revoke-from revoke-to)))
...
;; init for lnswap testing
(ft-mint? wrapped-usd u100000000000 'ST30VXWG00R13WK8RDXBSTHXNWGNKCAQTRYEMA9FK)
(ft-mint? wrapped-usd u100000000000 'ST27SD3H5TTZXPBFXHN1ZNMFJ3HNE2070QX7ZN4FF)
(ft-mint? wrapped-usd u100000000000 'ST1N28QCRR03EW37S470PND4SPECCXQ22ZZHF97GP)
(ft-mint? wrapped-usd u100000000000 'ST3RXC1Q8MXYKPWRNQ6ZFAWSRY8PKRK8H4BW2F8F)
(ft-mint? wrapped-usd u100000000000 'STJ4J7FPHJRJ4Y91650TG58K136JH64VFK6V6DD3)