...
class RskWalletProvider implements WalletProviderInterface {
  public readonly symbol: string;

  // The gas needed for sending Rsk is 21000?
  private readonly ethTransferGas = BigNumber.from(21000);

  constructor(private logger: Logger, private signer: Signer) {
    this.symbol = 'RBTC';
    this.logger.info('Initialized Rsk wallet');
  }
...
export default RskWalletProvider;
