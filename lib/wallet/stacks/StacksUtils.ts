...
import { broadcastTransaction, BufferReader, deserializeTransaction, estimateContractFunctionCall, sponsorTransaction, makeSTXTokenTransfer , bufferCV,
  standardPrincipalCV,
  AnchorMode,
...
import { EtherSwapValues, Sip10SwapValues } from '../../consts/Types';
...
export const getAddressBalance = async (address:string):Promise<any> => {
...
export const getAddressAllBalances = async (initAddress?:string):Promise<any> => {
...
export const setStacksNetwork = (network: string, stacksConfig: StacksConfig, derivedPrivateKey: string, derivedSignerAddress: string, signerNonce: number, currentBlockHeight: number):any => {
...
export const getStacksNetwork = ():any => {
...
export const getFee = async ():Promise<any> => {
...
export const getFeev2 = async (estimated_len: number, transaction_payload: string):Promise<any> => {
  try {
    // console.log("stacksutils.95 getFee ", coreApiUrl);
    const reqobj = {
      estimated_len,
...
export const setBlockHeight = (currentBlockHeight: number):any => {
  blockHeight = currentBlockHeight;
};

export const getAccountInfo = async (initAddress: string):Promise<any> => {
  let queryAddress = signerAddress;
  if(initAddress !== undefined){
    queryAddress = initAddress;
  }
...
export const getAccountNonce = async (initAddress?: string):Promise<any> => {
  let queryAddress = signerAddress;
  if(initAddress !== undefined){
    queryAddress = initAddress;
  }
...
export const incrementNonce = ():any => {
  nonce = nonce + 1;
};

export const getTx = async (txid:string):Promise<any> => {
...
export const calculateStxOutTx = async (nftContract:string, contractSignature:string):Promise<any> => {
...
export const getStacksRawTransaction = async (txid:string):Promise<any> => {
...
export const getStacksContractTransactions = async (address:string, limit?:number, offset?:number, height?:number):Promise<any> => {
...
export const listenContract = async (address:string):Promise<any> => {
...
export const calculateStacksTxFee = async (contract:string, functionName:string, amount: string, timelock: string, preimageHash?: Buffer, preimage?: Buffer, claimPrincipal?: string):Promise<any> => {
  try {
...
export const calculateMintFee = async (contract:string, functionName:string, userAddress:string, mintCost:number):Promise<any> => {
  const contractAddress = contract.split('.')[0];
  const contractName = contract.split('.')[1];
...
export const mintNFTforUser = async (contract:string, functionName:string, userAddress:string, mintCost:number):Promise<any> => {
  const contractAddress = contract.split('.')[0];
  const contractName = contract.split('.')[1];
...
export const sponsorTx = async (tx:string, minerfee:number):Promise<any> => {
  const txId = '';
  try {
...
export const sendSTX = async (address:string, amount: number, memo: string):Promise<any> => {
  const txId = '';
  try {
